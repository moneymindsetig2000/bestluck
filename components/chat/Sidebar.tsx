...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, onToggleCollapse, user, onLogout, onLogin, isAuthChecking, chatSessions, activeChatId, onSelectChat, onNewChat, onInitiateDelete, onHelpClick }) => {
  return (
