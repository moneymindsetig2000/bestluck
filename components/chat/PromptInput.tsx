...
const PromptInput: React.FC<PromptInputProps> = ({ onSend, isLoading, isSignedIn, onImagesChange }) => {
            ...
            <div className="relative bg-[#2f2f2f] rounded-xl p-3 shadow-lg border border-zinc-700">
                ...
                <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center gap-4 text-sm text-gray-400">
                        <button className="flex items-center gap-1.5 hover:text-white transition-colors disabled:opacity-50" disabled={!isSignedIn}>
                        ...
                        <input
                            ...
                            disabled={!isSignedIn}
                        />
                        <button onClick={() => fileInputRef.current?.click()} className="flex items-center gap-1.5 hover:text-white transition-colors disabled:opacity-50" disabled={!isSignedIn}>
                    ...
                    <div className="flex items-center gap-3">
                        <button 
                            ...
                            disabled={(!text.trim() && images.length === 0) || isLoading || !isSignedIn}
