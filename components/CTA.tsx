...
const Logo = () => (
    <div className="flex items-center gap-4 z-10">
      <svg width="40" height="40" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        <ellipse cx="14" cy="14" rx="12" ry="5" transform="rotate(45 14 14)" stroke="url(#g1-cta)" strokeWidth="2.5"/>
        <ellipse cx="14" cy="14" rx="12" ry="5" transform="rotate(-45 14 14)" stroke="url(#g2-cta)" strokeWidth="2.5"/>
        <defs>
          <linearGradient id="g1-cta" x1="2" y1="14" x2="26" y2="14" gradientUnits="userSpaceOnUse">
            <stop stopColor="#67E8F9"/>
            <stop offset="1" stopColor="#0891B2"/>
          </linearGradient>
          <linearGradient id="g2-cta" x1="2" y1="14" x2="26" y2="14" gradientUnits="userSpaceOnUse">
